...
var questionsQuizz : [Question] = [
    ...
    Question(topic: "Qu'est ce que la gamlification",number: 3, points: 70, proposition1: "un nouveau jeu vidéo sur les moutons cosmiques", proposition2: "La rencontre de 2 gamètes dans l'utérus", proposition3: "L'art de transformer des tâches ennuyeuses en aventures excitantes", proposition4: "Une competition pour savoir qui mange le plus de pizza en 1 heure", validProposition: [3]),
    Question(topic: "Sur quels principes psychologiques s’appuie la gamification ?", number: 4, points: 100, proposition1: "La stimulation de la motivation intrinsèque(plaisir et auto-satisfaction)", proposition2: "La conscientisation des désirs inconscients et des sentiments conflictuels", proposition3: "Vas-y c’est quoi cette question ?", proposition4: "Le renforcement de la motivation extrinsèque (récompense et reconnaissance)", validProposition: [1,3]),
    Question(topic: "Qu'est-ce qui peut vous aider à atteindre vos objectifs de gamification",number: 5, points: 80, proposition1: "Un café magique qui vous donne +10 en motivation chaque heure", proposition2: "Ajoutes des points, de la personnalisation, des challenges", proposition3: "Devenir photographe et choisir ses objetifs", proposition4: "La reponse D", validProposition: [2,4]),
    Question(topic: "La gamification est efficace dans l'apprentissage parce que :",number: 6, points: 90, proposition1: "Les etudiants sont secrètement des ninjas affamés de connaissances", proposition2: "Elle transforme l'apprentissage en une aventure captivante et interactive", proposition3: "Elle donne une excuse pour porter des costumes excentriques", proposition4: "Les cerveaux des étudiants adorent les explosions de confettis numériques", validProposition: [2]),
    Question(topic: "Depuis quand existe le principe de gamification ?",number: 7, points: 90, proposition1: "Depuis la nuit des temps (environ", proposition2: "en -2600 avant JC", proposition3: "En 1850 durant la révolution industrielle", proposition4: "Juin 1996 et l'étude de Richard Bartle", validProposition: [1,4]),
    Question(topic: "Quel est l’intérêt de la gamification pour un développeur ?", number: 8, points: 200, proposition1: "Changer sa façon de concevoir une app", proposition2: "Collecter des données sur le comportement des utilisateurs de l’app", proposition3: "Faire du fric avec des achats in-app", proposition4: "Fideliser et inciter les utilisateurs à rester actif sur l’app", validProposition: [1,2,3,4]),
    Question(topic: "Qu'est-ce qu'une bonne gamification ?",number: 9, points: 90, proposition1: "C'est une gamification, elle est là, elle gamifie", proposition2: "C'est une gamification, elle est là, elle gamifie, mais c'est pas pareil", proposition3: "Quand elle vous motive sans que l'on s'en rende compte", proposition4: "Vous savez, moi je ne crois pas qu'il y ait de bonne ou de mauvaise gamification. Moi si je devais resumer ma vie aujourd'hui avec vous, je dirais que c'est d'abord des rencontres", validProposition: [3,4]),
    Question(topic: "La gamification est-elle forcement digitale ?",number: 10, points: 90, proposition1: "oui, car tout est digital, bous vivons dans la Matrice", proposition2: "non car en français digitale veut juste dire doigt", proposition3: "non mais un peu quand-même on va pas se le cacher", proposition4: "Non car elle peut s'appliquer dans tous les domains du quotidien", validProposition: [4]),
]
